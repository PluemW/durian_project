...
model_path = os.path.join(package_path, 'model', 'hu3.pt')

class DetectionDurian:
    def __init__(self):
        self.model = YOLO(model_path)               
        self.cap = cv2.VideoCapture(2)              
        self.threshold = {"x1": 200, "y1": 184, "x2": 400, "y2": 279, "x_center": 300, "y_center": 231}
...
class ros_node(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Int8MultiArray, 'detection_info', qos_profile)
    ...
    def timer_callback(self):
        ...
        msg = Int8MultiArray()
        msg.data = self.detection.get_detection_info()
